...
# two branches
gst-launch-1.0 -vvv -e v4l2src ! tee name=t t. ! queue ! videoscale ! video/x-raw,width=656,height=192 ! autovideosink t. ! queue ! videoscale ! video/x-raw,width=1920,height=544,framerate=30/1 ! omxh264enc control-rate=1 target-bitrate=3000000 ! h264parse ! matroskamux ! filesink  location=out.mkv
